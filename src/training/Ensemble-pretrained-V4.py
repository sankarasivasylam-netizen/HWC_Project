...
def main():
        ...
        output_dir = BASE_DIR / "output" / "Stage2" / "Ensemble" / "V4"
        ...
        for p in cnn_ensemble_model.modelA.network.features[-2:].parameters():
            p.requires_grad = True
        ...
        # unfreeze DenseNet121 last block
        for p in cnn_ensemble_model.modelB.network.features.denseblock3.parameters():
            p.requires_grad = True
        ...
        train_time = train_model(cnn_ensemble_model,train_loader_s2,val_loader_s2,device,output_dir,class_weights)
