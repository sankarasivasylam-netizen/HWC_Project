...
def eval_model(model,val_loader_s1,device,output_dir,class_names):
...
def main():
        ...
        train_model(res_model,train_loader_s1,val_loader_s1,device,output_dir)
        eval_model(res_model,val_loader_s1,device,output_dir,class_names)
        ...
        train_model(mnv2_model,train_loader_s1,val_loader_s1,device,output_dir)
        eval_model(mnv2_model,val_loader_s1,device,output_dir,class_names)
        ...
        train_model(dn121_model,train_loader_s1,val_loader_s1,device,output_dir)
        eval_model(dn121_model,val_loader_s1,device,output_dir,class_names)
