...
def main():
        ...
        train_model(res_model,train_loader_s2,val_loader_s2,device,output_dir,class_weights)
        ...
        train_model(mnv2_model,train_loader_s2,val_loader_s2,device,output_dir,class_weights)
        ...
        train_model(dn121_model,train_loader_s2,val_loader_s2,device,output_dir,class_weights)
